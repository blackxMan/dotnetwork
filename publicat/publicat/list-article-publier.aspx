<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="list-article-publier.aspx.cs" Inherits="publicat.list_article_publier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="breadcrumbHolder" runat="server">
    ...
    <li class="active">Articles publiers</li>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="row-fluid">
		...
		<div class="table-header">
			les artivles deja publier sur le site
		</div>
				...
				<tr>
					...
					<td class="td-actions">
						<div class="hidden-phone visible-desktop action-buttons">
							<a class="blue" href="#" title="voir">
								<i class="icon-zoom-in bigger-130"></i>
							</a>
                            
							<a class="red" href="#" title="annuler la publication">
